...
//        dump(request()->host().request()->url());die;
		
        $url = $_SERVER['HTTP_REFERER']?$_SERVER['HTTP_REFERER']:'';

        $telphone = input('post.telphone')?intval(input('post.telphone')):'';
        ...
        $data = [];
//        'http://apis.juhe.cn/mobile/get?phone='.$telphone.'&key=9c8ed8d80d0bd8d59bbc0094e8294dbc'

//        $location =  $this->getApiData('http://apis.juhe.cn/mobile/get?phone='.$telphone.'&key=9c8ed8d80d0bd8d59bbc0094e8294dbc');
