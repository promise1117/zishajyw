...
Route::any('vmovinggoodslist', 'backend/Goods/getList1');    //动态商品列表
...
Route::any('vordereditall', 'backend/Order/editAll');    //订单修改
...
// 优玖游戏
Route::rule('game','backend/Game/game');
Route::rule('game_list','backend/Game/gameList');
Route::rule('game_link','backend/Game/gameLink');
